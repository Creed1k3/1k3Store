<template>
  ...
  export default {
    ...
    data() {
      return {
        currentIndex: 0,
        itemsToShow: 4, // Количество видимых элементов
        gap: 20, // Отступ между элементами
        items: [
          { image: "https://picsum.photos/300/200", link: "/page1", alt: "Image 1" },
          { image: "https://picsum.photos/500/200", link: "/page2", alt: "Image 2" },
  ...
  .carousel-item {
    ...
    flex: 0 0 calc(25% - 15px); /* Ширина элемента: 25% минус отступы */
    height: 200px;
  }
